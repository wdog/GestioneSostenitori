...
new #[Title('Trasimeno Prog Supporters')] class extends Component
{
    //
};
?>
    ...
    <main>
        <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            ...
            <div class="mt-16 grid gap-8 sm:grid-cols-3">
                <div class="group rounded-2xl border-2 border-emerald-500/30 bg-slate-900/80 p-8 text-center shadow-lg shadow-emerald-500/5 transition hover:border-emerald-500/50 hover:bg-slate-900 hover:shadow-emerald-500/10">
                    <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-500/20 ring-4 ring-emerald-500/10">
                ...
                <div class="group rounded-2xl border-2 border-blue-500/30 bg-slate-900/80 p-8 text-center shadow-lg shadow-blue-500/5 transition hover:border-blue-500/50 hover:bg-slate-900 hover:shadow-blue-500/10">
                    <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-500/20 ring-4 ring-blue-500/10">
                ...
                <div class="group rounded-2xl border-2 border-purple-500/30 bg-slate-900/80 p-8 text-center shadow-lg shadow-purple-500/5 transition hover:border-purple-500/50 hover:bg-slate-900 hover:shadow-purple-500/10">
                    <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-purple-500/20 ring-4 ring-purple-500/10">
